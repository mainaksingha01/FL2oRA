...
class Caltech101(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train_new, val_new, test_new = OxfordPets.subsample_classes(total_train, val, test, subsample='new')
        ...
        super().__init__(train_x=train, federated_train_x=federated_train_x, val=val, federated_test_x=federated_test_x, test=test, test_new=test_new)
