...
_C.LORA = CN()
_C.LORA.ENCODER = 'both' #choices=['text', 'vision', 'both']
_C.LORA.POSITION = 'all'  #choices=['bottom', 'mid', 'up', 'half-up', 'half-bottom', 'all', 'top3']
_C.LORA.PARAMS = ['q', 'k', 'v']
_C.LORA.R = 2
_C.LORA.ALPHA = 1
_C.LORA.DROPOUT_RATE = 0.25
_C.LORA.SAVE_PATH = 'lora_outputs'
...
_C.CALIBRATION.PROCAL = CN()
_C.CALIBRATION.PROCAL.IF_PROCAL = False #  density estimator / bin-mean-shift
_C.CALIBRATION.PROCAL.IMAGE_K = 5 # calculation the knn distance for proximity-base calibration, for small dataset, set 5 , for imagenet, set 10

# config for calibration metrics
_C.CALIBRATION.METRICS = CN()
_C.CALIBRATION.METRICS.ECE_BINS = 10 # the number of bins for ece calculation
_C.CALIBRATION.METRICS.PIECE_BINS = 10