...
from Dassl.dassl_bton.utils import read_image
from Dassl.dassl_bton.data.datasets import DATASET_REGISTRY
...
class DataManager:
    ...
    def __init__(
        ...
        test_loader_new = build_data_loader(
            cfg,
            sampler_type=cfg.DATALOADER.TEST.SAMPLER,
        ...
        self.classnames_new = dataset.classnames_new
