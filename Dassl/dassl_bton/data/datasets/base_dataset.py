...
from Dassl.dassl_bton.utils import check_isfile
...
class DatasetBase:
    ...
    def __init__(self, train_x=None, federated_train_x=None, train_u=None, val=None, federated_test_x=None, test=None, test_new=None):
        ...
        self._lab2cname_new, self._classnames_new = self.get_lab2cname(test_new)
    ...
    @property
    def classnames_new(self):
        return self._classnames_new
