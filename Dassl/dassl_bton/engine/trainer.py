...
from Dassl.dassl_bton.data import DataManager
from Dassl.dassl_bton.optim import build_optimizer, build_lr_scheduler
from Dassl.dassl_bton.utils import (
    MetricMeter, AverageMeter, tolist_if_not, count_num_param, load_checkpoint,
    save_checkpoint, mkdir_if_missing, resume_from_checkpoint,
    load_pretrained_weights
)
from Dassl.dassl_bton.modeling import build_head, build_backbone
from Dassl.dassl_bton.evaluation import build_evaluator
import os
...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        self.test_loader = dm.test_loader
        self.test_loader_new = dm.test_loader_new
    ...
    def test(self, split=None, is_global=False, current_epoch=0, idx=-1,global_test=False):
        ...
        if split == "val" and self.val_loader is not None:
            ...
            data_loader = self.test_loader_new
        else:
